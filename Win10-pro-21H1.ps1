...
<unattend xmlns="urn:schemas-microsoft-com:unattend">
    <settings pass="offlineServicing">
        ...
        <ProductKey>HNRT8-CGFH2-9TXVF-QBQCP-GQ84T</ProductKey>
        <RegisteredOrganization>Bergey's Inc</RegisteredOrganization>
        <RegisteredOwner>Joseph Deng</RegisteredOwner>
